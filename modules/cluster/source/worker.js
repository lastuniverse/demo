...
class Worker extends Emitter {
  ...
  /**
   * Отправить связанному удаленному процессу сообщение (у объекта модуля Cluster в удаленном
   * процессе будут вызваны обработчики одноименного события)
   *
   ...
   *                               проходить процедуру JSON.parse(JSON.stringify(param)) без потери
   *                               данных и ошибок
   */
